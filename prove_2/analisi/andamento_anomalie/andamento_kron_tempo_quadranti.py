...
# =============================================================================
print("\n--- FASE 4: Generazione riquadri per TUTTI gli oggetti non catalogati (Corrispondenza = NO) ---")
cartella_tutti_no = Path(f"tutti_gli_oggetti_non_catalogati_immagine_{INDICE_IMMAGINE_RIFERIMENTO}_run_{RUN_REF+1}")
