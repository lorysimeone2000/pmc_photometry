...
# =============================================================================
# 6. HYPER-IN-DEPTH ANALYSIS: POSITION, OCCURRENCES, RUNS AND FLUX
# =============================================================================

print("\n=== Hyper-In-Depth Analysis: Position, Occurrences, Runs, and Flux ===")
...
etichette_matrice = ['RA', 'DEC', 'Occurrences', 'Numero Run', 'Kron flux mean']
...
scatter_3d_run = ax3d_run.scatter(df_corr['Numero_Run'], df_corr['Occurrences'], df_corr['Kron_flux_mean'],
                                  c=df_corr['Kron_flux_mean'], cmap='plasma', s=40, depthshade=True, edgecolors='k', linewidth=0.2)

ax3d_run.set_xlabel('Numero di Run')
ax3d_run.set_ylabel('Occorrenze')
ax3d_run.set_zlabel('Kron flux mean')
...
cbar_3d_run.set_label('Kron flux mean', fontsize=12)

nome_3d_run_plot = cartella_output / "3d_run_occurrences_flux.png"
plt.savefig(nome_3d_run_plot, dpi=300)
print(f"3D Analysis (Run/Occurrences/Flux) plot saved at: {nome_3d_run_plot}")
plt.show()