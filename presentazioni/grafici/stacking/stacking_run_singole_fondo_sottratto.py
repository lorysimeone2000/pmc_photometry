...
for run in [1, 2, 3]:
    ...
    output_filename = os.path.join(output_dir, f'run_{run}_stacked_sum_fondo_sottratto_nelle_singole_immagini.fits')
    ...
    coverage_filename = os.path.join(output_dir, f'run_{run}_coverage_map_fondo_sottratto_nelle_singole_immagini.fits')
