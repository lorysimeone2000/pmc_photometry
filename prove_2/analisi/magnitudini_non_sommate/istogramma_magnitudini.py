...
mags_catalogo_totali = mag_cat_data
mags_trovate_correlate = mag_data
num_cat_min_10 = np.sum(mags_catalogo_totali < 10.0)
num_corr_min_10 = np.sum(mags_trovate_correlate < 10.0)
num_non_correlate_min_10 = num_cat_min_10 - num_corr_min_10

# Stampa del risultato
print(f"\n--- ANALISI SORGENTI MANCANTI (MAG < 10) ---")
print(f"Stelle nel catalogo con Mag < 10: {num_cat_min_10}")
print(f"Stelle trovate e correlate con Mag < 10: {num_corr_min_10}")
print(f"-> Sorgenti catalogate NON correlate con Mag < 10: {num_non_correlate_min_10}")
print("----------------------------------------------\n")
