...
filename = "/home/lorysimeone/tesi_magistrale/prove_2/analisi/magnitudini/studio_flussi_segmentazione/dispersione_flusso/risultati_analisi_run_1.csv"
# Lettura dati
...
# Estrazione colonne
medie_kron = tbl['media_flusso']
std_kron = tbl['std_flusso']
...
# Titoli ed etichette
plt.title(f'Errore in funzione della somma apertura media di ogni stella')
plt.xlabel('somma apertura media nella run (Scala Logaritmica)')
