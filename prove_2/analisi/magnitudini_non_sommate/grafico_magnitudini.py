...
plt.scatter( tbl_rank1['Mag'], tbl_rank1['kron_flux'], s=15, c='blue', alpha=alpha, label='Rank 1 (magnitudine massima)')
plt.scatter(tbl_rank2['Mag'], tbl_rank2['kron_flux'], s=15, c='green', alpha=alpha, label='Rank 2')
plt.scatter(tbl_rank3['Mag'], tbl_rank3['kron_flux'], s=15, c='red', alpha=alpha, label='Rank 3')
plt.scatter(tbl_altri_rank['Mag'], tbl_altri_rank['kron_flux'], s=15, c='yellow', alpha=alpha, label='Altri rank')
plt.scatter(y_no_corr, tbl_no_corr['kron_flux'], s=15, c='orange', marker='x', label='Non Correlate')
