...
stella_senza_tagli_2 = df_rimanente[(df_rimanente['label'] == 'RA_84.56DEC22.01')]
stella_senza_tagli_3 = df_rimanente[(df_rimanente['label'] == 'RA_87.25DEC24.57')]
stella_senza_tagli_4 = df_rimanente[(df_rimanente['label'] == 'RA_84.63DEC18.35')]

# concateno le mie 4 selezioni in un unico dataframe
df_filtrato = pd.concat([stella_senza_tagli,stella_senza_tagli_2,stella_senza_tagli_3,stella_senza_tagli_4])
...
percorso_candidati = cartella_output / "stelle_tesi.csv"
