...
# MODIFICA: Creo la figura con WCS per gli assi RA/DEC
fig = plt.figure(figsize=(12, 8))
ax = plt.subplot(projection=w)  # Usa la proiezione WCS
...
# MODIFICA: Formatto i tick per mostrare i gradi con decimali
ax.coords[0].set_format_unit(u.deg)
ax.coords[1].set_format_unit(u.deg)

# MODIFICA: Personalizzo i tick per una migliore leggibilità
