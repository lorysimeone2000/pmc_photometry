...
for anno in [2025, 2026]:
    ...
    if not percorso_c or not percorso_sum:
        raise FileNotFoundError(f"Errore: impossibile trovare i file globali di Markarian 421 per l'anno {anno}.")
    ...
    print(f"Copertura massima totale raggiunta per il {anno}: {full_coverage_value} immagini")
    ...
    # aggiungo la colorbar SNR con i parametri per l'altezza corretta
