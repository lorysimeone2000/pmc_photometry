...
filename = os.path.join(output_dir, f'stronzata_wcs_pix2world.csv')
...
plt.title('Numero di stelle del catalogo nel riquadro in funzione della run con pix2world')
