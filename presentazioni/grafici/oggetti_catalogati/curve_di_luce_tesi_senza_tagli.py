...
output_dir = cerca_cartella_nel_progetto(BASE_DIR, 'curve_di_luce_senza_tagli')
...
for label in tqdm(labels_presenti):
    ...
    # estraggo la mia magnitudine vera associata a questo specifico label
    mag_vera = df_label['Mag_vera'].iloc[0]

    # creo la figura per il grafico ottimizzando le dimensioni per 0.90\textwidth in LaTeX
    plt.figure(figsize=(16, 6))

    # aggiungo la mia retta orizzontale rossa in corrispondenza della magnitudine vera
