...
tbl_catalogate_corr = tbl[tbl['Corrispondenza'] == 'SI']
tbl_catalogate_non_corr = tbl[tbl['Corrispondenza'] == 'NO']

mag_finta = 4.
y_non_corr = np.full(len(tbl_catalogate_non_corr), mag_finta)
...
plt.title('Relazioni magnitudini su tre immagini di tre run diverse')

size = 6

plt.scatter(x, y, s=size)
plt.title('Relazione max_value/kron_flux')
